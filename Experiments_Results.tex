...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.8\textwidth, height=0.5\textheight, keepaspectratio] {tabulate_precision_recall_1.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.8\textwidth, height=0.5\textheight, keepaspectratio] {tabulate_precision_recall_2.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.8\textwidth, height=0.5\textheight, keepaspectratio] {decode_rank_1.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.9\textwidth, height=\textheight, keepaspectratio] {decode_rank_1_to_4.png}
	\caption{Percentage of relevant classes at ranks 1 to 4}
	\label{fig:decode_all_rank_acccuracy}
\end{figure}

Figure~\ref{fig:decode_all_rank_acccuracy} shows the distribution of relevant class labels at different ranks in the system. As concluded from Figure~\ref{fig:decode_rank_1_acccuracy}, we can see that most of the relevant class labels are found at rank 1. Very few relevant class labels are found at ranks 2 and 3. It is observed that none of the lower ranks from 4 have the relevant class labels. Due to the almost structured nature of the log file, we get a lot of rows with appropriate column values, leading to proper annotation of the column.
